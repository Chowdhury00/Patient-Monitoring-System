...
const char* ssid = "Donald Trump"; // your wifi SSID name
const char* password = "musasapientum" ;// wifi pasword
...
const char* WIFI_SSID = "Donald Trump";      // Put here your Wi-Fi SSID
const char* WIFI_PASS = "musasapientum";      // Put here your Wi-Fi password
